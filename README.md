...
int main()
{
    ...
    scanf("%lld", &p);
    printf("Enter the curve parameters for equation y^2 = x^3 + ax + b: ");
    scanf("%lld %lld", &a, &b);
...
<img width="563" height="352" alt="image" src="https://github.com/user-attachments/assets/9fac790f-c2fc-43b0-a6e3-e0e4e35fb1d3" />
